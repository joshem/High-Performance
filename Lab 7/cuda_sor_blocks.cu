...
int main(int argc, char** argv) {
	...
	//Launch the kernel, avoids blocks interacting with each other
	for(i=0;i<=ITERS;i++)
		kernal_SOR<<<gridsize, dimblock>>>(arrLen,d_x,d_result);
